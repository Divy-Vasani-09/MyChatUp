        ...
        <div className='container center flex flex-col  mx-auto mt-9  w-2/6'>
            <div className='container text-white bg-slate-900 py-9 px-0 rounded-2xl  items-center text-center shadow-slate-500 drop-shadow shadow-md '>
                ...
                <div className='text-center items-center m-3'>
                    <button type='submit' onClick={onSubmitValidation} className=' font-bold text-slate-300  bg-blue-800 hover:bg-blue-700 my-1 mx-0 p-1 px-4 rounded-lg w-4/6 h-9'>Submit </button>
                </div>
